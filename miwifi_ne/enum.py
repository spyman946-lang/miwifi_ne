...
class DeviceClass(StrEnum):
    ...
    MODE = "miwifi_ne__mode"
    SIGNAL_STRENGTH = "miwifi_ne__signal_strength"
    DEVICE_TRACKER = "miwifi_ne__device_tracker"
...
class Model(str, Enum):
    ...
    R4AV2 = "r4av2"  # 2022
    CB0401 = "cb0401"  # 2022
    RC02 = "rc02"  # Xiaomi Router AX3000 NE (INT), ipq5018
    RD28 = "rd28"  # Xiaomi Mesh System AX3000 NE (INT), ipq5018
    WR30 = "wr30"  # Xiaomi AX3000 NE (CN), ipq5018
    WR30U = "wr30u"  # Unicom variant
    WR30T = "wr30t"  # Telecom variant
    WR30M = "wr30m"  # Mobile variant
