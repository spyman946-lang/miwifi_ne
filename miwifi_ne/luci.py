...
class LuciClient:
    ...
    def __init__(
        ...
        self._set_base_url("http")

        self.diagnostics: dict[str, Any] = {}

    def _set_base_url(self, scheme: str) -> None:
        """Set LuCI base URL (http or https)."""

        self._url = f"{scheme}://{self.ip}/cgi-bin/luci"
    ...
    async def login(self) -> dict:
        ...
        for scheme in ("http", "https"):
            ...
            except _conn_errors as _e:  # type: ignore[misc]
        ...
        raise LuciConnectionError("Connection error") from last_exc
